        ...
        <main id="main">
            <div class="compare__inner container">
                <div class="compare__top">
                    ...
                    <span class="desc">+버튼을 눌러서 비교할 상품을 더 추가할 수 있습니다.</span>
                ...
                <div class="compare__bottom column2">
                    <div class="compare__left">
                        <div class="compare__left__top">
                            ...
                            <p class="price price1"><em>-</em>원</p>
                            <div class="pLink1">
                                <a href="#" class="btn__style3" target="_black">바로가기</a>
                            </div>
                        </div>
                    ...
                    <div class="compare__center">
                        <div class="compare__left__top">
                            ...
                            <p class="price price3"><em>-</em>원</p>
                            <div class="pLink3">
                    ...
                    <div class="compare__center2">
                        <div class="compare__left__top">
                            ...
                            <p class="price price4"><em>-</em>원</p>
                            <div class="pLink4">
                                <a href="#" class="btn__style3">바로가기</a>
                            </div>
                        </div>
                    ...
                    <div class="compare__right">
                        <div class="compare__right__top">
                            ...
                            <p class="price price2"><em>-</em>원</p>
                            <div class="pLink2">
                                <a href="#" class="btn__style3">바로가기</a>
                            </div>
                        </div>
